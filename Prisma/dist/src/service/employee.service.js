...
const getEmployees = async () => employeeRepository.findEmployees();
exports.getEmployees = getEmployees;
const getEmployeeById = async (employeeId) => {
    const employee = await employeeRepository.findEmployeeById(employeeId);
    return (0, service_util_1.ensureFound)(employee, "Employee not found.");
};
exports.getEmployeeById = getEmployeeById;
const updateEmployee = async (employeeId, data) => {
    await (0, exports.getEmployeeById)(employeeId);
